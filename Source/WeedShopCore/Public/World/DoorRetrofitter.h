...
protected:
	...
	// Zolang de loading-cover op beeld staat juist VERSNELD (0.4s): de sweep-hitches zijn dan onzichtbaar.
	int32 ScanIdleStreak = 0;
	bool bScanSlow = false;
	float ScanRate = 2.0f; // huidige timer-cadans (0.4 cover-op-beeld / 2.0 actief / 8.0 idle)
