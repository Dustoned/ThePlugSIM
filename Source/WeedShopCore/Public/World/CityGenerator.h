...
#include "World/CityTypes.h"    // FApartmentHome / FCityPropertyOffer / FCityMapBlock (verhuisd, beach-map gebruikt ze)
...
// (FApartmentHome / FCityPropertyOffer / FCityMapBlock zijn verhuisd naar World/CityTypes.h.)
...
private:
	...
	bool bNavCoverageRetryQueued = false;
	float NextNavCoverageRetryRealTime = 0.f;
