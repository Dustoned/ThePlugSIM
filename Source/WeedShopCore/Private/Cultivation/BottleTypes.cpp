...
{
	// ItemId,                  DisplayName,    Charges, Buy,   MinPhase
	static const TArray<FBottleDef> Defs = {
		{ TEXT("WaterBottle_Plastic"),  TEXT("Plastic bottle"), 3,  1000,  0 },
		{ TEXT("WaterBottle_Steel"),    TEXT("Steel bottle"),   6,  4500,  0 },
		{ TEXT("WaterBottle_Jerrycan"), TEXT("Jerry can"),      12, 15000, 1 },
		{ TEXT("WaterBottle_Tank"),     TEXT("Water tank"),     25, 45000, 2 },
	};
	return Defs;
}
