...
const TArray<FPlaceableDef>& GetAllPlaceables()
{
	...
	static const TArray<FPlaceableDef> Defs = {
		...
		{ TEXT("Wardrobe"), TEXT("Wardrobe"), TEXT("/Engine/BasicShapes/Cube.Cube"), FVector(1.1f, 0.5f, 2.0f), FVector(55.f, 25.f, 100.f), false, 14000, false, false, false, false, false, false, false, false, false, false, /*bIsSafe*/ false, /*bIsWardrobe*/ true },
